...
public class ProcessSubSegmentMethodTest {
    ...
    public void testNullPropertiesSegment() {
        OvertureRoadSegment segment = new OvertureRoadSegment(
                null,
                null,
                null
        );
    ...
    private OvertureRoadSegment getFullNullRangeSegment() {
        return new OvertureRoadSegment(
                ...
                new OvertureRoadProperties(
                        ...
                        emptyList(),
                        List.of(
                                new OvertureProhibitedTransition(null, TravelHeading.FORWARD, null, null)
                        ),
                        List.of(
                                new OvertureRoadSurface(RoadSurfaceType.UNPAVED, null)
                        ),
                        List.of(
                                new OvertureRoadFlags(false, false, true, false, false, false,
                                        null),
                                new OvertureRoadFlags(false, false, false, false, true, false,
                                        null)
                        ),
                        List.of(
                        ...
                        List.of(
                                new OvertureWidthRule(1.5, null)
                        ),
                        OvertureRoadSubclass.DRIVEWAY,
                        List.of(
                                new OvertureSubclassRule(OvertureRoadSubclass.DRIVEWAY, null)
                        ),
                        List.of(
                                new OvertureAccessRestriction(AccessType.ALLOWED,
                                        new PropertyScopeContainer(null, null, null, null),
                                        null),
                                new OvertureAccessRestriction(AccessType.DENIED,
                                        new PropertyScopeContainer(null, null, null, null),
                                        null)
                        ),
                        0,
                        List.of(
                                new OvertureLevelRule(1, null)
                        ),
                        OvertureTheme.TRANSPORTATION,
                        OvertureFeatureType.SEGMENT,
                        1,
                        List.of(
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w1162595551@3",
                                        OffsetDateTime.parse("2025-09-18T18:49:17Z"), 0, null),
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w1430995640@1",
                                        OffsetDateTime.parse("2025-09-18T18:49:17Z"), 0, null)
                        ),
                        new OvertureNames("Казкова вулиця", null,
                                List.of(
                                        new OvertureNameRule(Variant.COMMON, null, null, "Казкова вулиця", null, null),
                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("uk"), null, "Казкова вулиця", null, null)
                                )),
    ...
    private OvertureRoadSegment getSubSegmentFromNullRange(double startLr, double endLr) {
        ...
        return new OvertureRoadSegment(
                ...
                new OvertureRoadProperties(
                        List.of(
                                new OvertureConnector("81cf7f6f-a0b4-4f6b-a035-0fc2aa8d7c2f", (0.687772409-startLr)*recalMult),
                                new OvertureConnector("0431ceba-653a-4bde-9e54-fae36dccf194", (0.767664764-startLr)*recalMult)
                        ),
                        List.of(
                                new OvertureRoute("route-1", "network-1", "ref-1", "symbol-1", "wikidata", null)
                        ),
    ...
    private OvertureRoadSegment getFullSegment() {
        return new OvertureRoadSegment(
                ...
                new OvertureRoadProperties(
                        ...
                        List.of(
                               new OvertureRoute("Київ – Одеса", "ua:international", "М-05", null, "Q1051588", new LinearlyReferencedRange(0.3, 0.6)),
                               new OvertureRoute("European route E95", "e-road", "E 95", null, "Q1165682", null)
                        ),
                        OvertureRoadClass.TRUNK,
                        emptyList(),
                        List.of(
                                new OvertureProhibitedTransition(null, TravelHeading.FORWARD, null, new LinearlyReferencedRange(0.8, 1.0))
                        ),
                        List.of(
                                new OvertureRoadSurface(RoadSurfaceType.UNPAVED, new LinearlyReferencedRange(0.687779337, 1.0))
                        ),
                        List.of(
                                new OvertureRoadFlags(false, false, true, false, false, false,
                        ...
                        OvertureRoadSubclass.DRIVEWAY,
                        List.of(
                                new OvertureSubclassRule(OvertureRoadSubclass.DRIVEWAY, new LinearlyReferencedRange(0.0, 0.756090663))
                        ),
                        List.of(
                                new OvertureAccessRestriction(AccessType.ALLOWED,
                                        new PropertyScopeContainer(null, null, null, null),
                        ...
                        0,
                        List.of(
                                new OvertureLevelRule(1, new LinearlyReferencedRange(0.0, 0.70))
                        ),
                        OvertureTheme.TRANSPORTATION,
                        OvertureFeatureType.SEGMENT,
                        1,
                        List.of(
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w1162595551@3",
                                        OffsetDateTime.parse("2025-09-18T18:49:17Z"), 0, new LinearlyReferencedRange(0.0, 0.687779337)),
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w1430995640@1",
                                        OffsetDateTime.parse("2025-09-18T18:49:17Z"), 0, null)
                        ),
                        new OvertureNames("Казкова вулиця", null,
                                List.of(
                                        new OvertureNameRule(Variant.COMMON, null, null, "Казкова вулиця", new LinearlyReferencedRange(0.0, 0.687779337), null),
                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("uk"), null, "Казкова вулиця", new LinearlyReferencedRange(0.0, 0.687779337), null)
                                )),
                        OvertureSegmentSubtype.ROAD
                )
        );
    ...
    private OvertureRoadSegment getSubSegmentFromFull(double startLr, double endLr) {
        ...
        return new OvertureRoadSegment(
                ...
                new OvertureRoadProperties(
                        List.of(
                                new OvertureConnector("020c04a7-536f-44bf-b591-510a390d4918", (0.0-startLr)*recalMult),
                                new OvertureConnector("81cf7f6f-a0b4-4f6b-a035-0fc2aa8d7c2f", (0.687772409-startLr)*recalMult),
                                new OvertureConnector("0431ceba-653a-4bde-9e54-fae36dccf194", (0.767664764-startLr)*recalMult)
                        ),
                        List.of(
                                new OvertureRoute("Київ – Одеса", "ua:international", "М-05", null, "Q1051588", new LinearlyReferencedRange((0.3-startLr)*recalMult, (0.6-startLr)*recalMult)),
                                new OvertureRoute("European route E95", "e-road", "E 95", null, "Q1165682", null)
                        ),
                        OvertureRoadClass.TRUNK,
                        emptyList(),
                        emptyList(),
                        List.of(
                                new OvertureRoadSurface(RoadSurfaceType.UNPAVED, new LinearlyReferencedRange((0.687779337-startLr)*recalMult, 1.0))
                        ),
                        List.of(
                                new OvertureRoadFlags(false, false, true, false, false, false,
                                        new LinearlyReferencedRange((0.038124959-startLr)*recalMult, (0.076249917-startLr)*recalMult))
                        ),
                        List.of(
                                new OvertureSpeedLimit(new OvertureSpeed(50.0, SpeedUnit.KM_H), null, null, null, null)
                        ),
                        ...
                        OvertureRoadSubclass.DRIVEWAY,
                        List.of(
                                new OvertureSubclassRule(OvertureRoadSubclass.DRIVEWAY, new LinearlyReferencedRange(0.0, (0.756090663-startLr)*recalMult))
                        ),
                        List.of(
                                new OvertureAccessRestriction(AccessType.ALLOWED,
                                        new PropertyScopeContainer(null, null, null, null),
                        ...
                        0,
                        List.of(
                                new OvertureLevelRule(1, new LinearlyReferencedRange(0.0, (0.70-startLr)*recalMult))
                        ),
                        OvertureTheme.TRANSPORTATION,
                        OvertureFeatureType.SEGMENT,
                        1,
                        List.of(
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w1162595551@3",
                                        OffsetDateTime.parse("2025-09-18T18:49:17Z"), 0, new LinearlyReferencedRange(0.0, (0.687779337-startLr)*recalMult)),
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w1430995640@1",
                                        OffsetDateTime.parse("2025-09-18T18:49:17Z"), 0, null)
                        ),
                        new OvertureNames("Казкова вулиця", null,
                                List.of(
                                        new OvertureNameRule(Variant.COMMON, null, null, "Казкова вулиця", new LinearlyReferencedRange(0.0, (0.687779337-startLr)*recalMult), null),
                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("uk"), null, "Казкова вулиця", new LinearlyReferencedRange(0.0, (0.687779337-startLr)*recalMult), null)
                                )),
                        OvertureSegmentSubtype.ROAD
                )
        );
    ...
    private OvertureRoadSegment getRealSegment() {
        return new OvertureRoadSegment(
                ...
                new OvertureRoadProperties(
                        ...
                        List.of(
                                new OvertureRoute("Київ – Одеса", "ua:international", "М-05", null, "Q1051588", null),
                                new OvertureRoute("European route E95", "e-road", "E 95", null, "Q1165682", null)
                        ),
                        null,
                        emptyList(),
                        emptyList(),
                        List.of(
                                new OvertureRoadSurface(RoadSurfaceType.PAVED, new LinearlyReferencedRange(0.0, 0.445472102)),
                                new OvertureRoadSurface(RoadSurfaceType.PAVED, new LinearlyReferencedRange(0.614667246, 1.0))
                        ),
                        emptyList(),
                        List.of(
                                new OvertureSpeedLimit(new OvertureSpeed(110.0, SpeedUnit.KM_H), null, null, new LinearlyReferencedRange(0.0, 0.042135502), null),
                                new OvertureSpeedLimit(new OvertureSpeed(50.0, SpeedUnit.KM_H), null, null, new LinearlyReferencedRange(0.042135502, 1.0), null)
                        ),
                        emptyList(),
                        OvertureRoadSubclass.DRIVEWAY,
                        emptyList(),
                        List.of(
                                new OvertureAccessRestriction(AccessType.ALLOWED,
                                        new PropertyScopeContainer(null, null, null, null, new ArrayList<>(List.of(TravelMode.BICYCLE)), null),
                                        new LinearlyReferencedRange(0.614667246, 1.0)),
                                new OvertureAccessRestriction(AccessType.DENIED,
                                        new PropertyScopeContainer(null, null, null, null, null,
                                                new ArrayList<>(List.of(new VehicleAttributes(DimensionRestriction.HEIGHT, ComparisonOperator.GREATER_THAN, 4.5, Units.M)))),
                                        new LinearlyReferencedRange(0.614667246, 1.0)),
                                new OvertureAccessRestriction(AccessType.DENIED,
                                        new PropertyScopeContainer(null, null, null, null, null, null), null)
                        ),
                        0,
                        emptyList(),
                        OvertureTheme.TRANSPORTATION,
                        ...
                        1,
                        List.of(
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w338761673@10",
                                        OffsetDateTime.parse("2025-06-05T13:24:35Z"), 0, new LinearlyReferencedRange(0.0, 0.042135502)),

                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w288980686@24",
                                        OffsetDateTime.parse("2024-11-07T06:25:48Z"), 0, new LinearlyReferencedRange(0.042135502, 0.445472102)),

                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w288980684@26",
                                        OffsetDateTime.parse("2024-11-07T06:25:46Z"), 0, new LinearlyReferencedRange(0.445472102, 0.513063618)),

                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w288980685@17",
                                        OffsetDateTime.parse("2024-11-07T06:25:47Z"), 0, new LinearlyReferencedRange(0.513063618, 0.614667246)),

                                new OvertureSource("routes", "OpenStreetMap", "ODbL-1.0", "r2314106@1098",
                                        null, 0, null),

                                new OvertureSource("routes", "OpenStreetMap", "ODbL-1.0", "r23751@293",
                                        null, 0, null),

                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w31875944@58",
                                        OffsetDateTime.parse("2024-11-06T20:36:07Z"), 0, null)
                        ),
                        new OvertureNames("Казкова вулиця", null,
                                List.of(
                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("ru"), null, "проспект Академика Глушкова",
                                                new LinearlyReferencedRange(0.042135502, 0.513063618), null),

                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("en"), null, "Akademika Hlushkova Avenue",
                                                new LinearlyReferencedRange(0.042135502, 1.0), null),

                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("pl"), null, "prospekt Akademika Głuszkowa",
                                                new LinearlyReferencedRange(0.042135502, 1.0), null),

                                        new OvertureNameRule(Variant.COMMON, null, null, "проспект Академіка Глушкова",
                                                new LinearlyReferencedRange(0.042135502, 1.0), null),

                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("uk-Latn"), null, "prospekt Akademika Hlushkova",
                                                new LinearlyReferencedRange(0.042135502, 1.0), null),

                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("uk"), null, "проспект Академіка Глушкова",
                                                new LinearlyReferencedRange(0.042135502, 1.0), null)
                                )
                        ),
                        OvertureSegmentSubtype.ROAD
    ...
    private OvertureRoadSegment getSubSegmentFromReal(double startLr, double endLr) {
        ...
        return new OvertureRoadSegment(
                ...
                new OvertureRoadProperties(
                        List.of(
                                new OvertureConnector("1e3bdbd5-6d29-4064-84c5-9a012b13fc6a", (0.614671213-startLr)*recalMult),
                                new OvertureConnector("20678a1a-51f0-4620-9f6a-6f3852f65ffa", (0.727085704-startLr)*recalMult),
                                new OvertureConnector("075180f6-55c3-44f3-8783-5bceae6b4b82", (0.80647897-startLr)*recalMult),
                                new OvertureConnector("e4acaf8d-9758-48ef-b2c2-09b8355c9834", (0.88923974-startLr)*recalMult)
                        ),
                        List.of(
                                new OvertureRoute("Київ – Одеса", "ua:international", "М-05", null, "Q1051588", null),
                                new OvertureRoute("European route E95", "e-road", "E 95", null, "Q1165682", null)
                        ...
                        emptyList(),
                        List.of(
                                new OvertureRoadSurface(RoadSurfaceType.PAVED, new LinearlyReferencedRange((0.614667246-startLr)*recalMult, 1.0))
                        ),
                        emptyList(),
                        List.of(
                                new OvertureSpeedLimit(new OvertureSpeed(50.0, SpeedUnit.KM_H), null, null, new LinearlyReferencedRange(0.0, 1.0), null)
                        ),
                        emptyList(),
                        OvertureRoadSubclass.DRIVEWAY,
                        emptyList(),
                        ...
                        List.of(
                                new OvertureSource("", "OpenStreetMap", "ODbL-1.0", "w288980685@17",
                                        OffsetDateTime.parse("2024-11-07T06:25:47Z"), 0, new LinearlyReferencedRange(0.0, (0.614667246-startLr)*recalMult)),
                        ...
                        new OvertureNames("Казкова вулиця", null,
                                List.of(
                                        new OvertureNameRule(Variant.COMMON, Bcp47LanguageTag.parse("en"), null, "Akademika Hlushkova Avenue",
                                                new LinearlyReferencedRange(0.0, 1.0), null),
