...
public class BetweenExtractorTest {
    ...
    void parseBetween_Valid() throws Exception {
        ...
        LinearlyReferencedRange range = BetweenExtractor.extractBetween(node, null,"a737f685-b66f-41f1-9ef7-1909ecd15195");
    ...
    void parseBetween_InvalidSize() throws Exception {
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[0.5]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[0.5, null]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
    ...
    void parseBetween_SchemaValidation() throws Exception {
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[-0.01, 0.5]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[0.5, 1.0001]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));

        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[0.4, 0.4]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
    }

    @Test
    @DisplayName("Should reject non-numeric values")
    void parseBetween_NonNumeric() throws Exception {
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[\"0.1\", \"0.8\"]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
        assertNull(BetweenExtractor.extractBetween(mapper.readTree("[0.1, \"text\"]"), null, "a737f685-b66f-41f1-9ef7-1909ecd15195"));
    }
