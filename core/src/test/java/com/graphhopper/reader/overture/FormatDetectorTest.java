...
class FormatDetectorTest {
    ...
    void testDetectGeoJson() {
        ...
        assertEquals(
                FormatDetector.DataFormat.GEOJSON,
                FormatDetector.detectFromFile(new File("/tmp/test_data.geojson")));
    }
    ...
    void testDetectParquet() {
        ...
        assertEquals(
                FormatDetector.DataFormat.PARQUET,
                FormatDetector.detectFromFile(new File("archive.parquet")));
    }

    @Test
    void testDetectGeoParquet() {
        assertEquals(
                FormatDetector.DataFormat.PARQUET, FormatDetector.detectFromPath("buildings.geoparquet"));
    }
    ...
    void testCaseInsensitivity() {
        ...
        assertEquals(FormatDetector.DataFormat.PARQUET, FormatDetector.detectFromPath("DATA.PARQUET"));
        assertEquals(
                FormatDetector.DataFormat.PARQUET, FormatDetector.detectFromPath("Data.GeoParquet"));
    }
