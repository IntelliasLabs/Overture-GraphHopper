...
public class OvertureSpeedLimitTest {
    ...
    void testStandardKmh() {
        OvertureSpeedLimit limit = createLimit(
    ...
    void testMphVariations() {
        OvertureSpeedLimit limit = createLimit(createSpeed(10.0, "mph"),
                createSpeed(5.0, "mph"),
                false);

        assertEquals(16.0934, limit.getMaxSpeedKmh(), DELTA,
                "Failed to convert variant: " + "mph");
    }
    ...
    void testUnknownUnitIgnored(String unit) {
        OvertureSpeedLimit limit = createLimit(createSpeed(50.0, unit),
                createSpeed(5.0, unit),
                false);

        assertEquals(50.0, limit.getMaxSpeedKmh(), DELTA,
                "Failed to convert variant: " + unit);
    }
    @Test
    void testMissingSpeedDataHandling() {
        OvertureSpeedLimit nullSpeedObj = createLimit(null, null, false);
        OvertureSpeedLimit nullValueObj = createLimit(createSpeed(null, "km/h"),
                null, false);
    ...
    void testFieldsStorage() {
        ...
        PropertyScopeContainer scope = new PropertyScopeContainer("Mo-Fr 08:00-18:00", null,
                null, null, null, null);
        OvertureSpeedLimit limit = new OvertureSpeedLimit(createSpeed(50.0, "km/h"),
                null, false, range, scope);
    ...
    void testEqualsAndHashCode() {
        /// Base Object
        OvertureSpeedLimit base = new OvertureSpeedLimit(createSpeed(50.0, "km/h"),
                createSpeed(30.0, "km/h"), false,
                new LinearlyReferencedRange(2.0, 4.5), new PropertyScopeContainer("Mo-Fr 08:00-18:00", null,
                null, null, null, null));

        /// Exact Copy
        OvertureSpeedLimit copy = new OvertureSpeedLimit(createSpeed(50.0, "km/h"),
                createSpeed(30.0, "km/h"), false,
                new LinearlyReferencedRange(2.0, 4.5), new PropertyScopeContainer("Mo-Fr 08:00-18:00", null,
                null, null, null, null));
        ...
        /// Diff Speed
        OvertureSpeedLimit diffSpeed = createLimit(createSpeed(60.0, "km/h"),
                createSpeed(30.0, "km/h"), false);
        ...
        OvertureSpeedLimit diffGeo = new OvertureSpeedLimit(createSpeed(50.0, "km/h"),
                createSpeed(30.0, "km/h"), false, range, null);
        assertNotEquals(base, diffGeo, "Must differ by geometry (between)");

        /// 5. Diff Scope (When)
        PropertyScopeContainer scope = new PropertyScopeContainer("Sun 08:00-18:00", null, null,
                null, null, null);
        OvertureSpeedLimit diffScope = new OvertureSpeedLimit(createSpeed(50.0, "km/h"),
                createSpeed(30.0, "km/h"), false, null, scope);
    ...
    void testToStringContainsData() {
        OvertureSpeedLimit limit = createLimit(createSpeed(50.0, "mph"),
                null, true);
